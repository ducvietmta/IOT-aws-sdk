...
// Get from console
// =================================================
#define AWS_IOT_MQTT_HOST              "a1x6wmsxy5q7hn.iot.us-east-1.amazonaws.com" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
...
#define AWS_IOT_CERTIFICATE_FILENAME   "4eb55a10a3-certificate.pem.crt" ///< device signed certificate file name
#define AWS_IOT_PRIVATE_KEY_FILENAME   "4eb55a10a3-private.pem.key" ///< Device private key filename
// =================================================
